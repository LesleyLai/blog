...
tags:
  - code
  - cpp
description: "这篇博文介绍了 C++ 标准库中的 std::align 函数，并以Arena 内存分配器作为示例来说明其用法。"
---
...
这一块内存既可以来自栈中，也可以是在堆中被 `mmap` 一次性分配。
...
是一个 C++20 的特性。在 C++20 之前，你需要使用 <code>reinterpret_cast</code>。
