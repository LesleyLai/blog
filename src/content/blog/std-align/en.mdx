...
<figure>
  <Image src={arena3} alt="Arena after allocating one uint8_t and one uint32_t" class="block m-20-auto" />
...
<figure>
  <Image src={arena4} alt="Alignment-aware arena after allocating one uint8_t and one uint32_t" class="block m-20-auto" />
