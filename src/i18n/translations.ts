...
const enTagTranslations = createTagTranslations({
  ...
  meta: { shortName: "Meta", longName: "This Site Itself" },
  ...
  plt: { shortName: "PLT", longName: "Programming Language Theory and Design" },
  ...
  rt: { shortName: "Ray Tracing" },
  rust: { shortName: "Rust" },
  scheme: { shortName: "Scheme" },
  selfhost: { shortName: "Selfhosted", longName: "Self-hosting" },
...
const zhTagTranslations: typeof enTagTranslations = createTagTranslations({
  ...
  meta: { shortName: "Meta", longName: "本站" },
  ...
  plt: { shortName: "编程语言原理", longName: "编程语言设计以及原理" },
  ...
  selfhost: { shortName: "自托管", longName: "自托管服务" },
